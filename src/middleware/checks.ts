...
export const checkEmailIsUnique = async (req: Request, res: Response, next: NextFunction) => {
  let { email } = req.body
...
export const checkNewEventParams = async (req: Request, res: Response, next: NextFunction) => {
